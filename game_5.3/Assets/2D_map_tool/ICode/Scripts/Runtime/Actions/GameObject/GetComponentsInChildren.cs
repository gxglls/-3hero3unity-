...
namespace ICode.Actions{
	...
	[Tooltip("Get all components in the GameObject or any of its children.")]
	[HelpUrl("http://docs.unity3d.com/ScriptReference/GameObject.GetComponentsInChildren.html")]
	[System.Serializable]
	public class GetComponentsInChildren : StateAction {
		[SharedPersistent]
		...
		public override void OnEnter ()
		{
			...
			if (componentType != null) {
				store.Value = gameObject.Value.GetComponentsInChildren (componentType,includeInactive.IsNone?false:includeInactive.Value);
			}
			if (!everyFrame) {
				Finish ();
			}
